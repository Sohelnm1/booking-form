...
Last Updated: " . now()->format('F j, Y'),
            'summary' => 'Terms and conditions governing the use of HospiPal services',
            'is_required' => true,
            'is_active' => true,
            'sort_order' => 1,
            'version' => '1.0',
...
Last Updated: " . now()->format('F j, Y'),
        ...
        ConsentSetting::create([
            ...
            'title' => 'Booking Consent and Agreement',
...
Last Updated: " . now()->format('F j, Y'),
            'summary' => 'Consent and agreement for booking HospiPal companion services',
            'is_required' => true,
            'is_active' => true,
            'sort_order' => 3,
            'version' => '1.0',
